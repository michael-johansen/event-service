	...
	<body>
		...
		<div id="show-event" class="content scaffold-show" role="main">
			...
			<ol class="property-list event">
				...
				<g:if test="${eventInstance?.createdDate}">
				<li class="fieldcontain">
					<span id="createdDate-label" class="property-label"><g:message code="event.createdDate.label" default="Created Date" /></span>
					
						<span class="property-value" aria-labelledby="createdDate-label"><g:formatDate date="${eventInstance?.createdDate}" /></span>
