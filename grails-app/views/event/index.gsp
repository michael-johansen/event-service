		...
		<div id="list-event" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="createdDate" title="${message(code: 'event.createdDate.label', default: 'Created Date')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${eventInstance.createdDate}" /></td>
